            ...
            <div className="flex w-[700px] h-[500px] bg-white rounded-3xl">
                ...
                <div className="w-[300px] h-[500px] bg-login-navy rounded-l-3xl flex flex-col p-6 pt-10">
                    ...
                    <div className="flex-1 relative">
                        ...
                        {/* 밝은 그레이 배경 원 */}
                        <img src="../../../images/lightGrayCircle.svg" className="absolute w-52 h-24 bottom-10 left-10 z-10"></img>
                        {/* 로봇 이미지 */}
                        <img src="../../../images/robot.png" className="absolute w-36 h-36 bottom-10 left-14 z-20"></img>
                    </div>
                    {/* 홍보웹 링크 */}
                    <div>
